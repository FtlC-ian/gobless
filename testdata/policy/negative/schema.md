...
- `expected` object:
  ...
  - `no_leak_assertions` array of strings that must not appear in the error response/log.

Fixtures must not contain real private keys, credentials, or production account IDs.
